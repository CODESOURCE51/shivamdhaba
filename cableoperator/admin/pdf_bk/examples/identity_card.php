...
<table width="290" align="center" height="350" cellspacing="0" cellpadding="0" style="border-bottom:1px thin #06C; border-top:1px thin #06C; border-right:1px thin #06C; border-left:1px thin #06C; border-radius:5px;">
  <tr>
    <td height="50" align="center" valign="middle" colspan="2" style="font-size:18px; font-weight:bold; color:#FFF; background-color:#1D84CF; border-bottom:1px solid #FFF;">'.$s['name'].'<br /><span style="font-size:12px;">ID CARD</span></td>
  </tr>
  <tr>
